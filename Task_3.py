...
class Task_3:
    ...
    field_translations = {
        ...
        'decimal_first_host': 'Десятичный первый хост',
        'binary_first_host': 'Двоичный первый хост',
        'decimal_last_host': 'Десятичный последний хост',
        'binary_last_host': 'Двоичный последний хост',
